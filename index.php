...
<div class="features_section" style="padding-top:20px; padding-bottom:40px;">
  <div class="inner_wrapper">
    <h3 style="margin-bottom:40px;">Watch Our Video</h3>
    <div class="video" style="display:block;width:90%;max-width:600px; margin:0 auto;">
    <iframe src="https://player.vimeo.com/video/276193404" width="100%" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
</div>
  </div>
</div>
  ...
  <div class="inner_wrapper">
    ...
    <div class="team_member_wrapper">
      ...
      <div class="team_member_avatar">
        <img src="site/images/team_member_1.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Papa Johns</p>
    
    </div>
    
    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_2.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Amazon</p>
    
    </div>
    
    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_3.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">iTunes</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_4.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">UBER</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_5.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Caffe Nero</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_6.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Britannia Hotels</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_7.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Etoro</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_8.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Booking.com</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_9.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Raileasy</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_10.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">JustPark</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_11.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">Gourmet Society</p>
    
    </div>

    <div class="team_member_wrapper">
      <div class="team_member_avatar">
        <img src="site/images/team_member_12.png" width="180" height="120" alt=""/>
      </div>
      <p class="team_member_position">UK Soccer Shop</p>
...
<form action="https://fan-hub.us17.list-manage.com/subscribe/post?u=6dfe35352d4ba1b955ee525dc&amp;id=bdf3482bb1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
  <label for="mce-EMAIL">We can email you when the app is released!</label>
  <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_6dfe35352d4ba1b955ee525dc_bdf3482bb1" tabindex="-1" value=""></div>
...
<script type="text/javascript" src="//downloads.mailchimp.com/js/signup-forms/popup/embed.js" data-dojo-config="usePlainJson: true, isDebug: false"></script><script type="text/javascript">require(["mojo/signup-forms/Loader"], function(L) { L.start({"baseUrl":"mc.us17.list-manage.com","uuid":"6dfe35352d4ba1b955ee525dc","lid":"bdf3482bb1"}) })</script>
